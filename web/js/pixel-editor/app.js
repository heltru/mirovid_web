(function($, window, document, undefined) {
    ...
    var Pixels = function( options ) {
        ...
        var privateVars      = {};
        privateVars.xPixels  = (options !== undefined && options.xPixels !== undefined) ? options.xPixels : 128;
        privateVars.yPixels  = (options !== undefined && options.yPixels !== undefined) ? options.yPixels : 64;
        privateVars.pixelH   = (options !== undefined && options.pixelH !== undefined) ? options.pixelH : 1280;
        privateVars.pixelW   = (options !== undefined && options.pixelW !== undefined) ? options.pixelW : 640;
        privateVars.pixels   = [];
    ...
    var ImageCanvas = function( options ) {
        ...
        privateVars.cContext.strokeStyle = "#000000";
    ...
    $(document).ready(function(){
        ...
        $('#saveBtn').on('click', function () {
            var cCanvas = $('<canvas/>').attr({width: 128, height: 64});
            var cContext = cCanvas.get(0).getContext("2d");
            var mPixels = iCanvas.get('pixels');

            for (var y = 1; y <= 128; y += 1) {
                for (var x = 1; x <= 64; x += 1) {
                    var currentPixel = mPixels.getPixel(x, y);
                    if (currentPixel.on === true) {
