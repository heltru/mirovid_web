        ...
        <div class="row">
            <div class="col s12 center">
                ...
                <div style="margin-top: 3em;">
                    <img style="width: 99%;" class="responsive-img" src="/images/how_math.png">
                </div>
        ...
        <div class="row" style="margin-top: 6em;">
            ...
            <div class="col s12 m6 ">
                <div class="flow-text">
                    ...
                    <ul class="def_list">
                        <li>
                            Более 8 200 автобусов в день едут перед этим местом через автовокзал администрации порта.
                        </li>
                ...
                <div class="col s12 m6 ">
                    <div class="flow-text">
                        ...
                        <ul class="def_list">
                            ...
                            <li>
                                Более 8 200 автобусов в день едут перед этим местом через автовокзал администрации
                                порта.
                            </li>
                            <li>Ежегодно через станцию ​​метро 42-й улицы проходят 66 000 000 человек</li>
                            <li>Несмотря на то, что размещение, расположение и время очень важны, отличная креативность
