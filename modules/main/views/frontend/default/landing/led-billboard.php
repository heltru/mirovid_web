            ...
            <div class="col s12 m6 ">
                <div class="flow-text">
                    ...
                    <ul class="def_list">
                        ...
                        <li>Аудитория перекрестока Ивана Попова/Воровского 10 000 человек</li>
                ...
                <div class="col s12 m6 ">
                    <div class="flow-text">
                        ...
                        <ul class="def_list">
                            ...
                            <li>
                                Место включает 17 номеров автобусов и 3 номера троллейбуса, маршруты проходят через: Филейку, ЮЗ, Октябрьский проспект, Центр, Радужный, Ганино
                            </li>
                            <li>Мощная инфраструктура: бассейны, каток, спортзалы, заводы предприятий, клубы</li>
