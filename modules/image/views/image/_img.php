...
<div class="row  <?=  ' '. ($new) ? 'itemImg' : 'lineImg'?>  "
    ...
    <div class="col-lg-3 col-xs-12" >
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <?php echo Html::fileInput($formName.'['.$id.'][file]',null,['accept' => 'image/*','class'=>'imgFile']); ?>
                <span style="display: none" class="raw_caption">размер <span class="raw_size">123 kb</span></span>
            </div>

            <div class="col-xs-12">
                <div class="form-group">
                    <a class="btn btn-xs btn-default btnImgOpt" style="margin-top: 0.3em;display: none">оптимиз.превью</a>
                    <span style="display: none" class="optimize-caption">размер <span class="optimize_size">100 kb</span></span>
                </div>
            ...
            <div class="col-xs-6">
                ...
                echo Html::checkbox( $formName.'['.$id.'][harshness]',$model->harshness,['class'=>'form-control imgLogo' ]);
                ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 pull-right" style="    margin-top: 1em;" >
                <div class="btn-group pull-right" role="group">
                    ...
                    <a class="btn btn-default imageDeleteN" href="<?=\yii\helpers\Url::to(['/admin/image/default/delete','id'=>$model->id])?>" data-id="<?= $model->id ?>">
