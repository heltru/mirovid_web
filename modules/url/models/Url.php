...
use backend\components\Transliteration;
use Yii;
...
class Url extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['redirect',  'crs', 'domain_id' ,'public','identity','pagination'], 'integer'],
            [[ 'real_canonical', 'title' ,'keywords'], 'string', 'max' => 255],
            [['href','h1' ], 'string', 'max' => 1000],
            [['type_url','action'   ], 'string', 'max' => 45],
            [['redirect'], 'default', 'value'=> 0],
            [['description_meta'], 'string'],
            [['description_meta'], 'default','value'=> ''],
            //     [['last_mod'],'default', 'value'=> '00:00:00 00:00:00'],

            [['last_mod','preHref','rawHref','old_href'], 'safe'],
    ...
    public function getRedirect_r(){
        return $this->hasOne(  Url::className(), ['id' => 'redirect']);
    }
    ...
    public function setUrlLink($model,$type,$action='view'){
        $this->type_url = $type;
    ...
    public function afterFind()
    {
        ...
        if ( $end ){
            $this->preHref = implode('/',$urlArr); // $this->href . '/' . $end;
            $this->href = $end;
        }
